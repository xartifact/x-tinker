  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Coding agent that reads the error, modifies source code, and returns a fix. Used for all code modification.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Select value={provider} onValueChange={setProvider}>
              ...
              <SelectContent>
                <SelectItem value="pi">pi (edits the working tree directly)</SelectItem>
            ...
            <p className="text-xs text-muted-foreground">
              Provider names: pi (default), acp, claude-code, opencode
            </p>
          </div>
          <div className="space-y-2">
            ...
            <Input id="config" value={agentConfig} onChange={(e) => setAgentConfig(e.target.value)} placeholder="provider=x-herald;model=Plan;timeout_ms=180000" className="font-mono" />
